...
### アクション3-1. 仙狐さんセリフ集
仙狐さんがアニメ内で使用していたフレーズを7つ選びました。クリックすると、チャットでセリフを発言します。**このセリフは通常のチャットと同様に送信され、Figuraを使用していないプレイヤーにも表示されます。**この機能を使用するにはFigura設定の**Chat Messages**が有効でないと機能しません。
