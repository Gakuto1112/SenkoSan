# SenkoSan（仙狐さん）
TVアニメ「世話やきキツネの仙狐さん」（とその原作）に登場するキャラクターを再現した、MinecraftのスキンMod「[Figura](https://modrinth.com/mod/figura)」向けスキン「SenkoSan（仙狐さん）」です。

対応Figuraバージョン：[0.1.0-rc9](https://modrinth.com/mod/figura/version/0.1.0-rc.9+1.19.2)
