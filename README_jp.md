...
# ごあんない
![夜空](./.github/README_images/head_sora.png)
ここは、**夜空**のブランチです。
...
アップデートの確認は、1日1回自動で行われますが、[アクションホイール](#アクション8-アバターアップデートの確認)より手動で行うこともできます。

新しいアバターのバージョンが利用可能な場合は、通知が送信されます。[アクションホイール](#アクション8-アバターアップデートの確認)より最新バージョンのダウンロードリンクが取得できますので、お使いのブラウザからアクセスしてください。
