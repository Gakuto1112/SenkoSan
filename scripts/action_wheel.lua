...
if host:isHost() then
	...
	--アクション3-2. 設定ページ
	ActionWheel.MainPages[3]:newAction(1):title(Language.getTranslate("action_wheel__main_3__action_2__title")):item("comparator"):color(200 / 255, 200 / 255, 200 / 255):hoverColor(1, 1, 1):onLeftClick(function ()
