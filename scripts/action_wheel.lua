...
function pings.main1_action5()
	runAction(function ()
		FoxJump:play()
		ActionWheelClass.ActionCount = FoxJump.AnimationCount
	end, function ()
		FoxJump:stop()
		ActionWheelClass.ActionCount = 0
	end)
...
function pings.main1_action6()
	runAction(function ()
		TailBrush:play()
		ActionWheelClass.ActionCount = TailBrush.AnimationCount
	end, function ()
		TailBrush:stop()
		ActionWheelClass.ActionCount = 0
	end)
