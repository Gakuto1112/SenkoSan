...
events.TICK:register(function()
	local rightArms = {models.models.main.Avatar.Body.Arms.RightArm, models.models.costume_disguise.Avatar.Body.Arms.RightArm}
	local leftArms = {models.models.main.Avatar.Body.Arms.LeftArm, models.models.costume_disguise.Avatar.Body.Arms.LeftArm}
