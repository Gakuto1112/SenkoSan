	...
	if host:isHost() then
		if not client:isPaused() then
			if Afk.AfkCount >= 1 then
				...
				Afk.AfkAnimationCount = (player:getVelocity():length() == 0 and lookDir == Afk.LookDIrPrev and Hurt.Damaged == "NONE" and not General.IsSneaking and Wet.WetCount == 0 and not Umbrella.Umbrella and not Warden.WardenNearby) and Afk.AfkAnimationCount + 1 or 0
