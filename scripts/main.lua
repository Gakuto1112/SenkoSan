events.ENTITY_INIT:register(function ()
	...
	BroomCleaning = require("scripts/broom_cleaning").new()
	VacuumCleaning = require("scripts/vacuum_cleaning").new()
	ClothCleaning = require("scripts/cloth_cleaning").new()
	HairCutClass = require("scripts/hair_cut")
	FoxJumpClass = require("scripts/fox_jump")
	TailBrushClass = require("scripts/tail_brush")
	KotatsuClass = require("scripts/kotatsu")
