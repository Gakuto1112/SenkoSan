events.ENTITY_INIT:register(function ()
	...
	TailBrushClass = require("scripts/actions/tail_brush")
	...
	EarpickClass = require("scripts/actions/earpick")
	TeaTimeClass = require("scripts/actions/tea_time")
	MassaseClass = require("scripts/actions/massage")
