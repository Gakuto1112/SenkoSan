...
Costume = {
	...
	onArmorChenge = function (armorIndex)
		if armorIndex == 1 then
			if Armor.ArmorVisible[1] then
				...
				elseif Costume.CurrentCostume == "SWIMSUIT" then
					...
					models.models.main.Avatar.Torso.Body.Hairs.BackHair:setVisible(false)
		...
		elseif armorIndex == 2 then
			models.models.main.Avatar.Torso.Body.Hairs.FrontHair:setPos(0, 0, Armor.ArmorVisible[2] and -1 or 0)
			models.models.main.Avatar.Torso.Body.Hairs.BackHair:setPos(0, 0, Armor.ArmorVisible[2] and 1 or 0)
