...
Costume = {
	...
	setCostume = function (costume)
		...
		if costume == "NIGHTWEAR" then
			models.models.main.Avatar.Torso.Body.BodyBottom.Bells:setVisible(false)
		...
		elseif costume == "DISGUISE" then
			...
			for _, modelPart in ipairs({models.models.main.Avatar.Head.HairAccessory, models.models.main.Avatar.Head.Cowlick, models.models.main.Avatar.Torso.Body.BodyBottom.Bells}) do
				modelPart:setVisible(false)
			end
		...
		elseif costume == "FOX_HOODIE_RED" then
			models.models.main.Avatar.Head.Ears:setVisible(player:getItem(6).id == "minecraft:chainmail_helmet")
			models.models.main.Avatar.Torso.Body.Hairs.BackHair:setVisible(Armor.ArmorVisible[1])
			for _, modelPart in ipairs({models.models.main.Avatar.Head.HairAccessory, models.models.main.Avatar.Head.Cowlick, models.models.main.Avatar.Torso.Body.BodyBottom.Bells}) do
				modelPart:setVisible(false)
			end
	...
	resetCostume = function ()
		for _, modelPart in ipairs({models.models.main.Avatar.Head, models.models.main.Avatar.Torso.Body.Hairs.BackHair}) do
		...
		models.models.main.Avatar.Torso.Body.BodyBottom.Bells:setVisible(not (Armor.ArmorVisible[2] or Armor.ArmorVisible[3]))
	...
	onArmorChenge = function (armorIndex)
		if armorIndex == 1 then
			if Armor.ArmorVisible[1] then
				...
				elseif Costume.CurrentCostume == "FOX_HOODIE_RED" or Costume.CurrentCostume == "FOX_HOODIE_WHITE" then
					for _, modelPart in ipairs({models.models.main.Avatar.Head.Ears, models.models.main.Avatar.Torso.Body.Hairs.BackHair}) do
						modelPart:setVisible(false)
					end
		...
		elseif armorIndex == 2 then
			if Armor.ArmorVisible[2] then
				for _, modelPart in ipairs({models.models.main.Avatar.Torso.Body.BodyBottom.Tail.CDisguiseT, models.models.main.Avatar.Torso.Body.BodyBottom.Bells}) do
					modelPart:setVisible(false)
				end
				models.models.main.Avatar.Torso.Body.Hairs.FrontHair:setPos(0, 0, -1)
				models.models.main.Avatar.Torso.Body.Hairs.BackHair:setPos(0, 0, 1)
			else
				models.models.main.Avatar.Torso.Body.BodyBottom.Bells:setVisible((Costume.CurrentCostume == "DEFAULT" or Costume.CurrentCostume == "KNIT" or Costume.CurrentCostume == "SANTA") and not Armor.ArmorVisible[3])
				if Costume.CurrentCostume == "DISGUISE" then
					models.models.main.Avatar.Torso.Body.BodyBottom.Tail.CDisguiseT:setVisible(true)
				end
				models.models.main.Avatar.Torso.Body.Hairs.FrontHair:setPos()
				models.models.main.Avatar.Torso.Body.Hairs.BackHair:setPos()
			end
		elseif armorIndex == 3 then
			if Armor.ArmorVisible[3] then
				for _, modelPart in ipairs({models.models.main.Avatar.Torso.Body.BodyBottom.Bells, models.models.main.Avatar.Torso.Body.BodyBottom.CMaidABB, models.models.main.Avatar.Torso.Body.BodyBottom.CMaidBBB, models.models.main.Avatar.Torso.Body.BodyBottom.CMiniSkirtBB}) do
					modelPart:setVisible(false)
				end
				...
				models.models.main.Avatar.Torso.Body.BodyBottom.Bells:setVisible((Costume.CurrentCostume == "DEFAULT" or Costume.CurrentCostume == "KNIT" or Costume.CurrentCostume == "SANTA") and not Armor.ArmorVisible[2])
