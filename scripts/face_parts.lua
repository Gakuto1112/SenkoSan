...
FaceParts.EyeTypeID = {NONE = -1, NORMAL = 0, SURPLISED = 1, TIRED = 2, CLOSED = 3, UNEQUAL = 4, NORMAL_INVERSED = 5, TIRED_INVERSED = 6}
FaceParts.MouthTypeID = {NONE = -1, CLOSED = 0, OPENED = 1}
FaceParts.ComplexionID = {NORMAL = 0, PALE = 1, BLUSH = 2}
...
---表情をリセットする。
function FaceParts.resetEmotion()
	FaceParts.EmotionCount = 0
	FaceParts.ComplexionCount = 0
end
