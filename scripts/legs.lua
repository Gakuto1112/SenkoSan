...
events.RENDER:register(function ()
	...
	models.models.main.Avatar.Body.BodyBottom.Legs.RightLeg:setPos(isCrouching and (math.abs(legsYRot) == 40 and (legsYRot == 40 and vectors.vec3(0, 5, -4) or vectors.vec3(-0.3, 3.7, -4)) or vectors.vec3(0, 4, -4)) or vectors.vec3())
	models.models.main.Avatar.Body.BodyBottom.Legs.LeftLeg:setPos(isCrouching and (math.abs(legsYRot) == 40 and (legsYRot == 40 and vectors.vec3(0.3, 3.7, -4) or vectors.vec3(0, 5, -4)) or vectors.vec3(0, 4, -4)) or vectors.vec3())
