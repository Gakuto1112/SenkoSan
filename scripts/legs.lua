...
events.RENDER:register(function ()
	...
	local rightLegRot = vanilla_model.RIGHT_LEG:getOriginRot().x * LegSwingMultiplayer[CostumeClass.CurrentCostume] + (General.IsSneaking and 30 or 0)
	local leftLegRot = vanilla_model.LEFT_LEG:getOriginRot().x * LegSwingMultiplayer[CostumeClass.CurrentCostume] + (General.IsSneaking and 30 or 0)
