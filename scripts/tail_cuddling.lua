...
events.TICK:register(function ()
	TailCuddlingClass.CanCuddleTail = animations["models.main"]["sit_down"]:getPlayState() == "PLAYING" and CostumeClass.CurrentCostume ~= "DISGUISE" and (not ArmorClass.ShowArmor or not ArmorClass.ArmorVisible[2])
