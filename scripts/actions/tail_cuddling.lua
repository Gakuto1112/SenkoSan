...
TailCuddling = General.instance({}, AnimationAction, function ()
	return SitDown.IsAnimationPlaying and CostumeClass.CurrentCostume ~= "DISGUISE" and (not ArmorClass.ShowArmor or not ArmorClass.ArmorVisible[2]) and not player:isWet() and WetClass.WetCount == 0
end, {models.models.tail_cuddling, models.models.tail_cuddling.SittingPlayer}, {models.models.tail_cuddling, models.models.tail_cuddling.SittingPlayer}, animations["models.main"]["tail_cuddling"], General.getAnimationsOutOfMain("tail_cuddling"), 0)
...
---尻尾モフモフアニメーションを停止する。
function TailCuddling.stop(self)
...
function TailCuddling.onAnimationTick(self)
