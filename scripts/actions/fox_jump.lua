...
FoxJump = General.instance({
	...
	FoxJump.TargetPos = vectors.rotateAroundAxis(-(player:getBodyYaw() % 360), 0, 0, 1, 0, 1):add(player:getPos()):floor()
	local block1_1 = world.getBlockState(FoxJump.TargetPos:copy():add(0, -1))
