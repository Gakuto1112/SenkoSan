...
end, models.models.dummy_player, models.models.dummy_player, animations["models.main"]["ear_cuddling"], {animations["models.dummy_player"]["ear_cuddling"], animations["models.costume_maid_a"]["ear_cuddling"], animations["models.costume_maid_b"]["ear_cuddling"], animations["models.costume_inari_girl"]["ear_cuddling"]}, 60)
