...
Sleeve = {
	...
	enable = function ()
		...
		events.RENDER:register(function ()
			...
			models.models.main.Avatar.Body.Arms.RightArm.RightArmBottom.RightSleeveBase:setRot(sleeveRot[1]:add(Sleeve.RightSleeveRotOffset):copy():applyFunc(function (axis)
				return math.clamp(axis, -20, 20)
			end))
			models.models.main.Avatar.Body.Arms.LeftArm.LeftArmBottom.LeftSleeveBase:setRot(sleeveRot[2]:add(Sleeve.LeftSleeveRotOffset):copy():applyFunc(function (axis)
				return math.clamp(axis, -20, 20)
			end))
