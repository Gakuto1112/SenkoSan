...
Language = {
	LanguageData = {
		...
		ja_jp = {
			...
			action_wheel__main_2__action_3__unavailable = "座ってから耳かきをしましょうか。",
			action_wheel__main_2__action_4__title = "お茶",
			action_wheel__main_2__action_4__unavailable = "座ってからお茶を飲みましょうかしら。",
			action_wheel__main_2__action_5__title = "まっさーじ",
			action_wheel__main_2__action_5__unavailable = "座ってからあなたをほぐしますね！",
