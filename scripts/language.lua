...
LanguageData = {
	en = {
		...
		action_wheel__main_1__action_3__unavailable = "I cannot sit down now.",
		...
		action_wheel__main_1__action_5__title = "Tea time",
		action_wheel__main_1__action_5__unavailable = "I will sip tea after I sit down!",
		action_wheel__main_1__action_6__title = "Massage",
		action_wheel__main_1__action_6__unavailable = "I will massage you after I sit down!",
	...
	jp = {
		...
		action_wheel__main_1__action_3__unavailable = "今は座れないのじゃ。",
		...
		action_wheel__main_1__action_5__title = "お茶",
		action_wheel__main_1__action_5__unavailable = "座ってからお茶をすすろうかのう。",
		action_wheel__main_1__action_6__title = "マッサージ",
		action_wheel__main_1__action_6__unavailable = "座ってからお主をほぐそうかのう。",
