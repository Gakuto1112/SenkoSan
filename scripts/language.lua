...
Language = {
	LanguageData = {
		en_us = {
			...
			action_wheel__main_3__title = "Avatar config 1",
			...
			action_wheel__main_4__title = "Avatar config 2",
			action_wheel__main_4__action_1__title = "Always use umbrella: ",
		...
		ja_jp = {
			...
			action_wheel__main_3__title = "あばたー設定1",
			action_wheel__main_3__action_1__title = "アタシは何を着ればよいのよ？§7（すくろーる）§r：",
			action_wheel__main_3__action_1__done_first = "§b",
			action_wheel__main_3__action_1__done_last = "§rに着替えたわよ！",
			action_wheel__main_3__action_2__title = "アタシは何と呼ばれればよいのよ？§7（すくろーる）§r: ",
			action_wheel__main_3__action_2__done_first = "アタシの呼び名を§b",
			action_wheel__main_3__action_2__done_last = "§rに変更したわよ！",
			action_wheel__main_3__action_3__title = "アタシの頭ぶろっくはどれがよいのよ？§7（すくろーる）§r: ",
			action_wheel__main_3__action_3__done_first = "アタシの頭ぶろっくを§b",
			action_wheel__main_3__action_3__done_last = "§rに変更したわ！",
			...
			action_wheel__main_4__title = "あばたー設定2",
			action_wheel__main_4__action_1__title = "傘を常にさす：",
