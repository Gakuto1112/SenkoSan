...
Language = {
	LanguageData = {
		...
		ja_jp = {
			...
			action_wheel__config__action_3__title = "わらわの頭ぶろっくはどれがよいのじゃ？§7（すくろーる）§r: ",
			action_wheel__config__action_3__done_first = "わらわの頭ぶろっくを§b",
			action_wheel__config__action_3__done_last = "§rに変更したのじゃ。",
