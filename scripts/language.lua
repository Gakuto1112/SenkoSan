...
Language = {
	LanguageData = {
		en_us = {
			...
			costume__partner = "Sen's costume",
		...
		ja_jp = {
			...
			action_wheel__refuse_action = "（今はそれどころじゃないわ...何かよからぬ気配を強く感じるの...）",
			...
			action_wheel__main_2__action_3__unavailable = "座ってから耳かきをするとしようかしら。",
			action_wheel__main_2__action_4__title = "お茶",
			action_wheel__main_2__action_4__unavailable = "座ってからお茶を飲もうかしら。",
			action_wheel__main_2__action_5__title = "まっさーじ",
			action_wheel__main_2__action_5__unavailable = "座ってからアンタをほぐしてあげるわ。",
