...
Language = {
	LanguageData = {
		en_us = {
			...
			costume__partner = "Shiro's costume",
			...
			message__sleep = "Good night...",
			message__sleep_together = "...You want to sleep together? Wouldn't you say so?...",
		...
		ja_jp = {
			...
			message__sleep = "おやすみなのじゃ...",
			message__sleep_together = "...一緒に寝たいなら、そう申さぬか...",
