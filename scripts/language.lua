...
LanguageData = {
	en = {
		...
		action_wheel__main__action_5__title = "Change display name (scroll): ",
		action_wheel__main__action_5__name_change_done_first = "Changed your name to §b",
	...
	jp = {
		...
		action_wheel__main__action_5__title = "お主は何と呼ばれたいのじゃ？（スクロール）: ",
		action_wheel__main__action_5__name_change_done_first = "お主の呼び名を§b",
		action_wheel__main__action_5__name_change_done_last = "§rに変更したのじゃ。"
	}
}
