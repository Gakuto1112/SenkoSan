...
LanguageData = {
	en = {
		...
		action_wheel__main_1__action_3__title = "Fox jump",
		action_wheel__main_1__action_3__unavailable = "I cannot jump here.",
		action_wheel__main_1__action_4__title = "Body shake",
		action_wheel__main_2__action_1__unavailable = "I cannot sit down now.",
		action_wheel__main_2__action_1__title = "Sit down",
		action_wheel__main_2__action_2__title = "Earpick",
		action_wheel__main_2__action_2__unavailable = "I will clean your ears after I sit down!",
		action_wheel__main_2__action_3__title = "Tea time",
		...
		action_wheel__word__action_8__title = "I will try other languages (scroll): §b",
	...
	jp = {
		...
		action_wheel__main_1__action_3__title = "きつねジャンプ",
		action_wheel__main_1__action_3__unavailable = "ここでは跳べないのじゃ。",
		action_wheel__main_1__action_4__title = "ブルブル",
		action_wheel__main_2__action_1__unavailable = "今は座れないのじゃ。",
		action_wheel__main_2__action_1__title = "おすわり",
		action_wheel__main_2__action_2__title = "耳かき",
		action_wheel__main_2__action_2__unavailable = "座ってから耳かきをするかのう。",
		action_wheel__main_2__action_3__title = "お茶",
		...
		action_wheel__word__action_8__title = "わらわもよその国の言葉に挑戦しようかのう（スクロール）: §b",
		action_wheel__word__action_8__bracket_begin = "（",
		action_wheel__word__action_8__bracket_end = "）"
	}
}
