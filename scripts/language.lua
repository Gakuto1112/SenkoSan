...
Language = {
	LanguageData = {
		en_us = {
			...
			message__respawn = "Uyaaan... You, I wish you would be a little gentler with me...",
		...
		ja_jp = {
			avatar__old_version_warning = "ばーじょん1.21.4以上で遊ぶことをおすすめするのじゃ！",
			...
			message__sleep_together = "一緒に寝たいなら、そう申すがよい...",
			message__respawn = "うや～ん...。お主よ、もう少し優しくしてほしいのじゃ...。",
