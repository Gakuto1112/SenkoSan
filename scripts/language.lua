...
Language = {
	LanguageData = {
		en_us = {
			...
			message__respawn = "Uyaaan... I'm glad if you would be a little gentler...",
		...
		ja_jp = {
			avatar__old_version_warning = "ばーじょん1.21.4以上で遊ぶことをおすすめします！",
			...
			action_wheel__main_1__action_3__unavailable = "今は掃除できないんです！",
			action_wheel__main_1__action_4__title = "散髪",
			action_wheel__main_1__action_4__unavailable = "今は髪を切ってあげられないんです！",
			action_wheel__main_1__action_5__title = "きつねじゃんぷ",
			action_wheel__main_1__action_5__unavailable = "ここでは跳べないんです！",
			action_wheel__main_1__action_6__title = "尻尾の手入れ",
			action_wheel__main_1__action_6__unavailable = "今は手入れできないんです！",
			...
			action_wheel__main_2__action_2__unavailable = "今はもふもふしてあげられないんです！",
			action_wheel__main_2__action_3__title = "お耳もふもふ",
			action_wheel__main_2__action_3__unavailable = "今はもふもふしてあげられないんです！",
			action_wheel__main_2__action_4__title = "耳かき",
			action_wheel__main_2__action_4__unavailable = "座ってから耳かきをしましょうか。",
			...
			action_wheel__main_3__action__unavailable = "今はぽーずをとれないんです！",
			action_wheel__main_2__action_6__unavailable = "座ってからあなたをほぐしますね！",
			action_wheel__main_4__title = "あばたー設定1",
			action_wheel__main_4__action_1__title = "わたしは何を着ればよいですか？§7（すくろーる）§r：",
			action_wheel__main_4__action_1__done_first = "§b",
			action_wheel__main_4__action_1__done_last = "§rに着替えました！",
			action_wheel__main_4__action_2__title = "わたしは何と呼ばれればよいですか？§7（すくろーる）§r: ",
			action_wheel__main_4__action_2__done_first = "わたしの呼び名を§b",
			action_wheel__main_4__action_2__done_last = "§rに変更しました！",
			action_wheel__main_4__action_3__title = "わたしの頭ぶろっくはどれがよいですか？§7（すくろーる）§r: ",
			action_wheel__main_4__action_3__done_first = "わたしの頭ぶろっくを§b",
			action_wheel__main_4__action_3__done_last = "§rに変更しました！",
			...
			message__sleep_together = "一緒に寝たいなら、そう言ってくださいね...",
			message__respawn = "うや～ん...。もう少し優しくしてください...。",
