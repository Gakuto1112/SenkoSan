...
Language = {
	LanguageData = {
		...
		ja_jp = {
			...
			action_wheel__main_3__action_1__title = "わらわは何を着ればよいのじゃ？§7（すくろーる）§r：",
			action_wheel__main_3__action_1__done_first = "§b",
			action_wheel__main_3__action_1__done_last = "§rに着替えたのじゃ。",
			action_wheel__main_3__action_2__title = "わらわは何と呼ばれればよいのじゃ？§7（すくろーる）§r: ",
			action_wheel__main_3__action_2__done_first = "わらわの呼び名を§b",
			action_wheel__main_3__action_2__done_last = "§rに変更したのじゃ。",
			action_wheel__main_3__action_3__title = "わらわの頭ぶろっくはどれがよいのじゃ？§7（すくろーる）§r: ",
			action_wheel__main_3__action_3__done_first = "わらわの頭ぶろっくを§b",
