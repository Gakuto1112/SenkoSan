...
PhotoPose = {
    ...
    setPose = function (poseID)
        if PhotoPose.check() then
            ...
            if poseID == 7 then
                ...
                models.models.main.Avatar.Torso.Arms.RightArm.RightArmBottom:setRot(50)
                Sleeve.RightSleeveRotOffset = vectors.vec3(7.5)
                Arms.LeftArmRotOffset = vectors.vec3(12.5, -47.5)
                models.models.main.Avatar.Torso.Arms.LeftArm.LeftArmBottom:setRot(50)
                ...
                models.models.main.Avatar.Torso.Body.UmbrellaB:setPos(1.25, -2, -0.25)
                models.models.main.Avatar.Torso.Body.UmbrellaB:setRot(35.58, 12.7, -38.26)
            else
                if poseID == 1 then
                ...
                elseif poseID == 2 then
                    ...
                    models.models.main.Avatar.Torso.Body.BodyBottom.Legs:setRot(15)
                ...
                elseif poseID == 4 then
                    ...
                    models.models.main.Avatar.Torso.Body.BodyBottom.Legs.LeftLeg.LeftLegBottom:setRot(-35)
                    models.models.main.Avatar.Torso.Body.BodyBottom.Legs.LeftLeg.LeftLegBottom:setPivot(-2, 6, -2)
                elseif poseID == 5 then
                    models.models.main.Avatar.Head:setRot(0, 0, -5)
                    Arms.RightArmRotOffset = vectors.vec3(28.76, -24.65, 17.83)
                    models.models.main.Avatar.Torso.Arms.RightArm.RightArmBottom:setRot(57.5)
                    Sleeve.RightSleeveRotOffset = vectors.vec3(-32.5, 10)
                    Arms.LeftArmRotOffset = vectors.vec3(69.35, 14.08, -5.24)
                    models.models.main.Avatar.Torso.Arms.LeftArm.LeftArmBottom:setRot(65)
                    Sleeve.LeftSleeveRotOffset = vectors.vec3(-60, -50)
                    Physics.EnablePyhsics[1] = false
                    models.models.main.Avatar.Torso.Body.BodyBottom.Tail:setPos(5)
                    Physics.TailRotOffset = vectors.vec3(155.7, -0.73, -171.31)
                    Apron.RotOffset = vectors.vec3(10)
                    Legs.RightLegRotOffset = vectors.vec3(-19.72, 3.4, 9.41)
                    models.models.main.Avatar.Torso.Body.BodyBottom.Legs.RightLeg.RightLegBottom:setRot(-20)
                    models.models.main.Avatar.Torso.Body.BodyBottom.Legs.RightLeg.RightLegBottom:setPivot(2, 6, -2)
                    Legs.LeftLegRotOffset = vectors.vec3(5.04, -7.47, 0.67)
                    models.models.main.Avatar.Torso.Body.BodyBottom.Legs.LeftLeg.LeftLegBottom:setRot(-10)
                    models.models.main.Avatar.Torso.Body.BodyBottom.Legs.LeftLeg.LeftLegBottom:setPivot(-2, 6, -2)
                elseif poseID == 6 then
                    ...
                    models.models.main.Avatar.Torso.Arms.LeftArm.LeftArmBottom:setRot(55)
                    Sleeve.LeftSleeveRotOffset = vectors.vec3(40)
                    Apron.RotOffset = vectors.vec3(22.5)
                    Legs.LeftLegRotOffset = vectors.vec3(25)
                    models.models.main.Avatar.Torso.Body.BodyBottom.Legs.LeftLeg.LeftLegBottom:setRot(-95)
                end
    ...
    stopPose = function ()
        ...
        models.models.main.Avatar.Torso.Body.BodyBottom.Legs.RightLeg.RightLegBottom:setPivot(2, 6)
        Legs.LeftLegRotOffset = vectors.vec3()
        models.models.main.Avatar.Torso.Body.BodyBottom.Legs.LeftLeg.LeftLegBottom:setPivot(-2, 6)
        Apron.RotOffset = vectors.vec3()
        models.models.main.Avatar.Torso.Body.UmbrellaB:setRot(20)
