...
UpdateChecker = {
    ...
    localeData = {
        ...
        ja_jp = {
            ...
            action_title_3 = "最新アバターのバージョンのURLをコピー";
            action_title_4 = "（右クリック）";
            msg_networking_api = "アップデートの確認機能を有効にするにはFiguraの設定から、FiguraのNetworkingの使用を許可して、\"api.github.com\"を許可リストに入れる必要がありますの。";
            msg_ongoing = "今アップデートの確認中をしてるところどす。";
            msg_copied = "最新のアバターへのリンクをコピーした。お主ブラウザで開いとぉくれやす。";
            msg_cannot_check_latest = "アバターの最新バージョンを確認できひんため、リンクを取得できしまへん。かんにんえ。";
        };
    };
